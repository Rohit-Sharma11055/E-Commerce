...
import { ArrowDown, ArrowUp, HelpCircle, Home, LogOut, Menu, Package, ShoppingCart, User, X } from 'lucide-react';


const MENU_ITEMS = [
  { text: "Dashboard", path: "/admin", icon: <Home size={20} /> },
  { text: "Products", path: "/admin/products", icon: <Package size={20} /> },
  { text: "Orders", path: "/admin/orders", icon: <ShoppingCart size={20} /> },
];
